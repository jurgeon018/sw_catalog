    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.CharField(blank=True, max_length=150, null=True, verbose_name='Артикул')),
            ],
            options={
                'verbose_name': 'товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order', models.PositiveIntegerField(default=0, verbose_name='Порядок')),
                ('image', models.ImageField(blank=True, null=True, upload_to=sw_catalog.utils.utils.item_image_folder, verbose_name='Ссилка зображення')),
        ...
        migrations.AddField(
            model_name='item',
            name='similars',
            field=models.ManyToManyField(blank=True, default=None, related_name='_sw_catalog_item_similars_+', to='sw_catalog.Item', verbose_name='Супутні товари'),
        ),
        migrations.AddField(
            model_name='item',
            name='unit',
